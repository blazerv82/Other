function snow() {
		debugger;
		var
			size_min = (typeof (snow_size_min) != 'undefined') ? snow_size_min : 14,
			size_max = (typeof (snow_size_max) != 'undefined') ? snow_size_max : 14,
			num_flakes = (typeof (snow_num_flakes) != 'undefined') ? snow_num_flakes : 75,
			...
			flake_image = (typeof (snow_flake_image) != 'undefined') ? snow_flake_image : "./pictures/snow.png",
			flake_color = (typeof (snow_flake_color) != 'undefined') ? snow_flake_color : '#FFFFFF',
			fall_speed = (typeof (snow_fall_speed) != 'undefined') ? snow_fall_speed : 25,
			flake_objects = [],

...
?>                    
                    <tr>
                        ...
                        <?php
                            ...
                            if ($reminded == 1) {
                                echo '<td class="table-success">Yes
                                        <a href="reminded.php?id=' . $id . '&amp;reminded=' . $reminded .'"
                                        <button class="btn btn-outline-dark btn-sm">NO?</button></a></td>';
                            }

                            else {
                                echo '<td class="table-danger">No
                                        <a href="reminded.php?id=' . $id . '&amp;reminded=' . $reminded .'"
                                        <button class="btn btn-outline-dark btn-sm">YES?</button></a></td>';
                            }

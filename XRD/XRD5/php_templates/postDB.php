...
class postDB{
    ...
    public function outputDBCart(){
        ...
        // Total Cost
        echo '<button class="btn btn-outline-dark" disabled>TOTAL COST: ' . $final_cart_price . '(G)</button>';
            
        // Sale
        echo '<a href="remove_cart.php"><button class="btn btn-outline-dark">REMOVE ALL ITEMS FROM CART</button></a></span>';
    
        // Purchase 
        echo '<a href="purchase_cart.php"><button class="btn btn-outline-dark">CONTINUE TO PURCHASE</button></a></span>';
    ...
    public function outputDBLimit($how_many){
        ...
        while ($row = mysqli_fetch_array($result)){
            ...
            // Placeholder Picture
            if(empty($picture)){
                echo '<img class="card-img-top" src="images/placeholder.png" />';
            }
            ...
            echo '<div class="card-img-overlay">
                <h1 class="card-title">' . $name . '</h1>
                <h5 class="text-muted">' . $price . '(G)' .'</h5></div>';
            
            echo '<div class="card-footer">' . $desc . '</div>';
    ...
    public function outputDBCurated($which_one){
        ...
        while ($row = mysqli_fetch_array($result)){
            ...
            echo '<div class="card-footer"><b>' . $desc . '</b><hr>
                <a href="cart_add.php' . $cart_string . '" class="link"><button class="btn btn-outline-light">ADD TO CART</button></a>
                </div></div>';
